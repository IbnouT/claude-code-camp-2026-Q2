...
function snapshot(player: string, requested?: number) {
  ...
  return {
    ...
    objective_initial: {
      title: beta ? "Map the eastern field" : "Find and fight the Minotaur",
      clue: beta ? null : "north of the Temple · newbie area",
    ...
    combat_episode: !beta && through === 4 ? {
      active: true,
      opponent: "Massive Minotaur",
      first_observed_turn: 12,
      observed_exchanges: 1,
      outcome: null,
      command_trace: "trace-alpha-4",
      lines: [{
        text: "The Massive Minotaur attacks.",
        sequence: 4,
        observed_at: 1_800_000_004,
        confidence: "medium",
    ...
    current_turn_cost_usd: beta ? 0.0021 : 0.0043,
    spend_cap_usd: 0.5,
