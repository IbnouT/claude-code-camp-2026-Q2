...
class Agent:
    ...
    def run(self) -> str:
        ...
        self._turn_duration_ms = 0.0
        while True:
            # Cancellation wins over everything: once the event is set, no
            # further model call is made and the turn ends now. The caller (the
            # REPL) records the cancellation and keeps history well-formed.
